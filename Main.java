...
public class Main {
    ...
    public static void main(String[] args) {
        //Chosing the type of Dictionary Helper
        DictionaryHelper helper = new TrieDictionaryHelper();
        
        //Passing that Dictionary helper into Dictionary object constructor 
